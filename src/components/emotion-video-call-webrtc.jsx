...
const EmotionVideoCallWithWebRTC = () => {
  ...
  const handleIceCandidate = async (data) => {
    try {
      console.log('📨 handleIceCandidate called with data:', data);
      ...
      console.log('🔍 Candidate object:', JSON.stringify(data.candidate));
      console.log('   Type:', data.candidate.type);
      console.log('   Protocol:', data.candidate.protocol);
      console.log('   Address:', data.candidate.address);
      console.log('   Port:', data.candidate.port);
      ...
      console.log(`✅ Remote ICE candidate #${remoteCandidateCount} added:`, data.candidate.type || 'unknown', data.candidate.protocol || 'unknown');
      setIceStats(prev => ({ ...prev, remoteCandidates: remoteCandidateCount }));
      
    } catch (error) {
      console.error('❌ Error adding ICE candidate:', error);
      console.error('   Candidate data was:', data);
